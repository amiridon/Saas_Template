...
exports.seed = async (knex) => {
    ...
    const memberships = [
        { id: 'm_admin_alpha', organization_id: 'o_alpha', user_id: 'u_admin', role: 'owner', status: 'active', created_at: now, updated_at: now },
        { id: 'm_alice_alpha', organization_id: 'o_alpha', user_id: 'u_alice', role: 'member', status: 'active', created_at: now, updated_at: now },
        { id: 'm_bob_beta', organization_id: 'o_beta', user_id: 'u_bob', role: 'member', status: 'active', created_at: now, updated_at: now },
    ];
